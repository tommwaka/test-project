...
<?php
  ...
  exit();
   ...
   if(isset($_GET['username'])){
	$user=$_GET['username'];
	$result = mysql_query("SELECT * FROM manager where username='$user'");
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="#"><i class="fa fa-user-md fa-fw"></i> Add staff</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
...
<div class="row" align="left">
  <form name="myform" onsubmit="return validateForm(this);"  method="post" action="ad.php">

  <div class="form-row" align="left">
      <div class="col-md-4"></div>
        <div class="form-group col-md-4">
          <label for="name">Firstname:</label>
          <input type="text" id="first_name" placeholder="nameeee" class="form-control" name="first_name" value="<?php echo $fname ?>">
        </div>
      </div>
