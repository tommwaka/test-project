...
$sql="INSERT INTO pharmacist(first_name,last_name,staff_id,postal_address,phone,email,username,password) VALUES(:fname,:lname,:sid,:postal,:phone,:email,:user,:pass)";
        ...
        <!-- end navbar side -->
          <div id="page-wrapper">
           ...
           <div class="grid-form">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">New Pharmacist</h1>
                </div>
                <!--End Page Header -->
            </div>
