...
$sql="update pharmacist set first_name=:fname,last_name=:lname,staff_id=:sid,postal_address=:postal,phone=:phone,email=:email,password=:pass where username=:user";
...
<?php
$pid=intval($_GET['pid']);
$sql = "SELECT * from pharmacist where pharmacist_id=:pid";
$query = $dbh -> prepare($sql);
