...
<td><a href="del_cashier.php?cashier_id=<?php echo $row['cashier_id']?>"><img src="images/delete-icon.jpg" width="35" height="35" border="0" /></a></td>
<?php
   }
      // close table>
      echo "</table>";
...
<form>
  <button formaction="add_cashier.php">New cashier</button>
</form>
  		</div>
