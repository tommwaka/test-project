...
$results=$query->fetchAll(PDO::FETCH_OBJ);
    ...
    $sql1="INSERT INTO cashier(first_name,last_name,staff_id,postal_address,phone,email,username,password,date)
...
include ('connect_db.php');
          ...
          <td> <a href="update_cashier.php?pid=<?php echo htmlentities($result -> cashier_id);?>" class= "btn btn-success" >update</a></td>
          <td> <a href="del_cashier.php?cashier_id=<?php echo htmlentities($result -> cashier_id);?>" class= "btn btn-warning" >Delete</a></td>
          </tr>
          <?php $cnt=$cnt+1; }} ?>
          	</table>

          			</p>
                      <button formaction="add_cashier.php" class= "btn btn-success">New Cashier</button>
          			</form>
